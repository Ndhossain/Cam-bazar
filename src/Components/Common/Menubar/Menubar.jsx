    ...
    return (
        <div className='border-b border-primary'>
            <nav className='flex justify-between items-center px-3 py-3 max-w-[1480px] mx-auto'>
                ...
                <ul 
                    className={`flex top-0 sm:flex-row flex-col gap-3 sm:relative fixed sm:translate-x-0 sm:h-min h-screen sm:w-min w-1/2 bg-primary sm:bg-white sm:text-primary text-white duration-300 ${responsiveNav ? 'translate-x-[100%]' : 'translate-x-[200%]'}`}
                >
                    ...
                    <li className='flex items-center relative group'>
                        <Link className='p-2 hidden sm:block' to='/login'><FaUserPlus size={22} color={responsiveNav ? '#fff' : '#222'} /></Link>
