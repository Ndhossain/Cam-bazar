...
const SellersRow = ({user, setModalStatus, setDeleteUid, handleVerify}) => {
                ...
                <td className="py-4 px-6">
                     {isVerified ? 'Verified' : (
                        <button
                            ...
                            className='px-3 py-1 border border-primary text-sm font-bold text-primary hover:bg-primary hover:text-white'
                        >Verify User</button>
                     )}
                </td>
                <td className="py-4 px-6">
